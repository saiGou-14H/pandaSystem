...
import com.saigou.config.MediaServerConfig;
...
public class MediaServerContext {
    ...
    public void initMediaServerConf() {
        ...
        ZLM_API.mk_ini_set_option(MK_INI, "general.mediaServerId", "MediaServer");
        ZLM_API.mk_ini_set_option(MK_INI, "http.notFound", "<h1 style=\"text-align:center;\">Media Server V1.0 By SaiGou</h1>");
